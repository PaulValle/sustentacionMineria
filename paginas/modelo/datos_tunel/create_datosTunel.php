...
<body>
    ...
    <div class="contLogin">
        ...
        <br>  
                 <br><br>  
                 <br>
                <form class="login" method="post" action="save_datosTunel.php">
                    <label >Oxigeno </label>
                    <input type="text" name="oxigeno" placeholder="Introduce el oxígeno">
                    <br>
		    <label >Metano </label>
                    <input type="text" name="metano" placeholder="Introduce el metano">
