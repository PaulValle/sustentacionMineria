...
<body>
    ...
    ?>
       <div class="container">
        ...
        <br>  
    <div class="contLogin">
                <h1>MODIFICAR DATOS TUNEL</h1>
         <br>
        <br>  
                 <br>
                <form class="login" method="post" action="save_update_datosTunel.php">
                      <?php
                        echo "<label >Id_DatosTunel</label>";

                        echo "<input type='text' name='id_DatosTunel' value='". $id ."' readonly>";
                        echo "<br>";

                        echo "<label >oxigeno </label>";
                        echo "<input type='text' name='oxigeno' value='". $oxigeno ."'>";
                        echo "<br>";

		        echo "<label >metano </label>";
                        echo "<input type='text' name='metano' value='". $metano ."'>";
                        echo "<br>";

                     echo "<a href='save_update_datosTunel.php?ID=". $id ."'><button type='submit'>Modificar</button></a>";
                    ?>
                </form>
            </div></div>
