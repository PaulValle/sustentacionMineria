...
<body>
    ...
    <div class="contLogin">
         ...
         <br>  
                 <br>
        <br>  
                <form class="login" method="post" action="save_dron.php">
                     <br>  
                    <label >Marca </label>
                    ...
                    <input type="text" name="numero" placeholder="Introduce el serial">
                    ...
                    <input type="text" name="minuto" placeholder="Introduce el tiempo en minuto">
